/* Psych Exam 3 - NCLEX Challenge Round - Mixed review across all six chapters
   ...
   Note: stems are written as direct NCLEX-style questions with no "per the study guide"
   framing -- the content is still sourced only from the guide, that's just no longer
   stated in the question text itself. */
window.QUESTIONS = [
  {
  ...
  {
    "stem": "Which client presentation reflects OCPD rather than OCD?",
    "options": [
  ...
  {
    "stem": "A client with dependent personality disorder has remained in a relationship she describes as emotionally abusive, stating, \"I can't take care of myself without him.\" As the nurse works with this client, what should the nurse specifically assess in themselves?",
    "options": [
  ...
  {
    "stem": "Which nursing priority applies across the personality disorders chapter as a whole, before any other treatment goal?",
    "options": [
  ...
  {
    "stem": "Which nursing actions correctly address a client with borderline personality disorder who is engaging in splitting on the unit? Select all that apply.",
    "options": [
  ...
  {
    "stem": "A patient with no cardiac history reports sudden chest pain, palpitations, sweating, and a fear of dying, and cannot communicate with staff. What is happening, and what must still be addressed?",
    "options": [
  ...
  {
    "stem": "A client says, \"It seems ridiculous, but I can't make myself go out the front door,\" and has become essentially housebound, only leaving when accompanied by a trusted person. Which disorder does this best describe, and what is known about the client's insight?",
    "options": [
  ...
  {
    "stem": "A client is pacing rapidly and escalating on the unit. What is the nurse's best action?",
    "options": [
  ...
  {
    "stem": "A client taking fluoxetine asks the nurse when to take the dose. Which teaching is correct?",
    "options": [
  ...
  {
    "stem": "A client in acute alcohol withdrawal needs a benzodiazepine. Which is most appropriate?",
    "options": [
  ...
  {
    "stem": "A client newly started on buspirone for GAD asks if she can take an extra dose when she feels an attack coming on. Which response reflects accurate teaching?",
    "options": [
  ...
  {
    "stem": "Which effects are part of chronic or prolonged stress? Select all that apply.",
    "options": [
  ...
  {
    "stem": "A client washes her hands for thirty minutes at a time. What purpose does this behavior serve for the client?",
    "options": [
  ...
  {
    "stem": "What distinguishes clinically significant obsessive-compulsive symptoms from occasional worry or habit?",
    "options": [
  ...
  {
    "stem": "How do OCD and OCPD differ along the ego-dystonic/ego-syntonic axis?",
    "options": [
  ...
  {
    "stem": "A client is midway through a checking ritual when a scheduled unit activity begins. What is the nurse's correct early approach?",
    "options": [
  ...
  {
    "stem": "A client with OCD reports intrusive thoughts about harming a family member and is frightened by these thoughts. What is the nurse's first priority?",
    "options": [
  ...
  {
    "stem": "A family asks the nurse whether OCD is a personality flaw or \"something he could stop if he tried harder.\" Which response is most accurate?",
    "options": [
  ...
  {
    "stem": "Which teaching point should the nurse include when educating a family about a relative's OCD symptoms?",
    "options": [
  ...
  {
    "stem": "A client repeatedly pulls out strands of hair from her scalp, resulting in noticeable bald patches, and reports it happens more when she is anxious. Which OCD-related disorder does this describe?",
    "options": [
      "Trichotillomania",
  ...
  {
    "stem": "A client has accumulated significant credit card debt from repeated, hard-to-control shopping episodes that bring brief relief followed by guilt. Which term best fits?",
    "options": [
      "Oniomania",
      "Excoriation",
      "Onychophagia",
  ...
  {
    "stem": "Which of the following are part of the OCD-related disorder family? Select all that apply.",
    "options": [
      "Trichotillomania",
      "Excoriation disorder",
  ...
  {
    "stem": "Recurring nightmares of the traumatic event and intrusive memories belong to which PTSD symptom cluster?",
    "options": [
      "Intrusion",
      "Avoidance",
  ...
  {
    "stem": "A client refuses to drive past the location of a car accident and avoids any conversation referencing it. This belongs to which PTSD cluster?",
    "options": [
      "Avoidance",
      "Intrusion",
      "Negative alterations in cognition and mood",
  ...
  {
    "stem": "A client repeatedly states \"I'm permanently broken\" and reports an inability to feel positive emotions since the trauma. This belongs to which PTSD cluster?",
    "options": [
      "Negative alterations in cognition and mood",
      "Intrusion",
      "Avoidance",
  ...
  {
    "stem": "A client checks every room immediately upon entering a building and has an exaggerated startle response. This belongs to which PTSD cluster?",
    "options": [
      "Arousal and reactivity",
      "Avoidance",
      "Intrusion",
  ...
  {
    "stem": "A client's trauma occurred three weeks ago and symptoms have been present since. Based on standard symptom-duration criteria, what is the appropriate classification now, and when would this change to PTSD?",
    "options": [
  ...
  {
    "stem": "A client develops emotional and behavioral symptoms out of proportion to a recent job loss, with no catastrophic traumatic event involved. Symptoms began two months ago. Which diagnosis is most consistent, and what determines resolution?",
    "options": [
  ...
  {
    "stem": "Which of the following would NOT be an expected finding in PTSD?",
    "options": [
  ...
  {
    "stem": "A client with PTSD specifically struggles with recurrent trauma-related nightmares. Which medication is used specifically to target this symptom, in addition to an SSRI?",
    "options": [
      "Prazosin",
      "Paroxetine",
      "Buspirone",
  ...
  {
    "stem": "A client has two or more distinct personality states with memory gaps for everyday events. What underlies this presentation, and what is the best treatment?",
    "options": [
  ...
  {
    "stem": "Two children both experienced grossly inadequate early caregiving. Child A is withdrawn and rarely seeks or responds to comfort. Child B is indiscriminately overfamiliar with strangers and will wander off with them without checking back. Which pairing is correct?",
    "options": [
  ...
  {
    "stem": "A client describes her partner as apologetic, bringing gifts and flowers, and promising to change, two days after an incident. Which phase of the cycle of violence does this represent, and why does this phase matter most for whether she stays?",
    "options": [
  ...
  {
    "stem": "A beating is triggered specifically by the victim announcing she plans to leave the relationship. Which phase of the cycle of violence does this episode belong to?",
    "options": [
  ...
  {
    "stem": "What is the single strongest predictor of a person's future violence?",
    "options": [
  ...
  {
    "stem": "Which bruising pattern should raise the nurse's suspicion for child abuse?",
    "options": [
  ...
  {
    "stem": "What is the most common form of child maltreatment?",
    "options": [
      "Neglect",
      "Physical abuse",
      "Sexual abuse",
  ...
  {
    "stem": "A mother describes her partner's violence occurring in front of her toddler; on one occasion, an object thrown at her struck the child. What is the nurse's legal duty, and does needing \"proof\" change it?",
    "options": [
  ...
  {
    "stem": "A sexual assault survivor says, \"I never should have been out alone.\" Which nursing response is most therapeutic?",
    "options": [
  ...
  {
    "stem": "A client reports being given a drink at a party, after which she experienced sedation, muscle relaxation, and near-total amnesia for the following hours. Which substance does this most closely match?",
    "options": [
  ...
  {
    "stem": "A competent adult client discloses ongoing intimate partner violence but is not ready to leave the relationship. What is the nurse's role, and why shouldn't the nurse pressure her to leave immediately?",
    "options": [
  ...
  {
    "stem": "Which nursing actions reflect appropriate priority sexual assault care? Select all that apply.",
    "options": [
  ...
  {
    "stem": "A client is pacing, has a rising voice, clenched fists, and early verbal threats. Which phase of the aggression cycle is this, and what is the nursing response?",
    "options": [
  ...
  {
    "stem": "A patient suddenly becomes aggressive on the unit. What is the nurse's first action, before anything else?",
    "options": [
  ...
  {
    "stem": "Which positioning is correct when the nurse approaches an agitated client to de-escalate?",
    "options": [
  ...
  {
    "stem": "Which of the following is a non-therapeutic response to an escalating client?",
    "options": [
  ...
  {
    "stem": "Which client presentation carries the highest risk for aggression toward others?",
    "options": [
  ...
  {
    "stem": "What is the correct order of the least-restrictive-first hierarchy for managing an aggressive patient?",
    "options": [
  ...
  {
    "stem": "An agitated manic patient throws a chair but hurts no one. The provider has ordered four-point restraints. What should the nurse do first, and does the order require immediate compliance?",
    "options": [
  ...
  {
    "stem": "Within what timeframe must a provider order and face-to-face assessment be obtained after emergency restraint application?",
    "options": [
      "Within 1 hour",
      "Within 4 hours",
      "Within 2 hours",
  ...
  {
    "stem": "Which set of restraint monitoring numbers is correct for an adult patient?",
    "options": [
  ...
  {
    "stem": "Which elements are legally required in restraint documentation? Select all that apply.",
    "options": [
  ...
  {
    "stem": "Which nursing approach is correct for a client with antisocial personality disorder?",
    "options": [
  ...
  {
    "stem": "A client with histrionic personality disorder is dramatic and seductive, and cries loudly when a request is denied. Which nursing approaches are appropriate? Select all that apply.",
    "options": [
  ...
  {
    "stem": "A client with avoidant personality disorder is reluctant to share feelings with the nurse. What is the most likely reason for this reluctance?",
    "options": [
  ...
  {
    "stem": "Which behaviors are characteristic of obsessive-compulsive personality disorder (OCPD)? Select all that apply.",
    "options": [
  ...
  {
    "stem": "Which are expected sympathetic (\"fight or flight\") physiologic signs of anxiety? Select all that apply.",
    "options": [
      "Tachycardia",
      "Hyperventilation",
      "Dry mouth",
  ...
  {
    "stem": "A client on venlafaxine for anxiety should be monitored for which effect?",
    "options": [
  ...
  {
    "stem": "A client with social anxiety disorder is prescribed propranolol specifically for an upcoming public speaking event. Which teaching is correct?",
    "options": [
  ...
  {
    "stem": "A client repeatedly picks at their skin until it bleeds, particularly during stressful periods, and reports difficulty stopping despite trying. Which OCD-related disorder does this describe?",
    "options": [
      "Excoriation disorder",
      "Trichotillomania",
      "Onychophagia",
  ...
  {
    "stem": "A client bites their nails to the point of bleeding and cuticle damage, especially when anxious. Which term describes this behavior?",
    "options": [
      "Onychophagia",
      "Excoriation",
      "Trichotillomania",
  ...
  {
    "stem": "Which treatment approach for OCD pairs medication with an evidence-based psychotherapy technique?",
    "options": [
  ...
  {
    "stem": "Which brain circuit is hyperactive in OCD?",
    "options": [
  ...
  {
    "stem": "Which pairings of term to definition are correct? Select all that apply.",
    "options": [
  ...
  {
    "stem": "A family member states the client \"chooses to keep washing her hands over and over because it feels good.\" Which correction best reflects why compulsions occur?",
    "options": [
  ...
  {
    "stem": "A veteran with PTSD frequently and eagerly volunteers vivid, boastful retellings of combat heroics to anyone who will listen, with no apparent distress. Does this presentation support a PTSD diagnosis?",
    "options": [
  ...
  {
    "stem": "How common is dissociative identity disorder, and what best characterizes its presentation?",
    "options": [
  ...
  {
    "stem": "A client's PTSD symptoms did not become clearly apparent until four months after the traumatic event, though onset may be delayed. Assuming the symptoms are now present and persistent, which diagnosis applies?",
    "options": [
  ...
  {
    "stem": "Which findings reflect the negative alterations in cognition and mood cluster of PTSD? Select all that apply.",
    "options": [
  ...
  {
    "stem": "Besides a history of violence, which factors are drivers of violence risk? Select all that apply.",
    "options": [
  ...
  {
    "stem": "Which are recognized types of abuse? Select all that apply.",
    "options": [
      "Physical abuse",
      "Sexual abuse",
  ...
  {
    "stem": "A client reports feelings of relaxation, euphoria, and disinhibition after an unknowingly altered drink at a party. Which substance most closely matches this?",
    "options": [
      "GHB",
      "Flunitrazepam (Rohypnol)",
      "Ketamine",
  ...
  {
    "stem": "A client describes a dream-like state during an assault and later realizes she was unusually compliant with requests, with the drink tasting normal beforehand. Which substance most closely matches this?",
    "options": [
      "Ketamine",
      "GHB",
      "Flunitrazepam (Rohypnol)",
  ...
  {
    "stem": "Why does family violence often run through generations?",
    "options": [
  ...
  {
    "stem": "Which substance is most commonly involved in sexual assault facilitation overall, even though drugs like GHB and Rohypnol are also implicated?",
    "options": [
      "Alcohol",
      "Ketamine",
      "Flunitrazepam",
  ...
  {
    "stem": "A sexual assault survivor becomes visibly anxious when asked to remove her clothing for the forensic exam without warning. What is the most appropriate nursing action, consistent with offering control and choices at every step?",
    "options": [
  ...
  {
    "stem": "Anger is best understood as what kind of emotion, and what nursing approach follows from this?",
    "options": [
  ...
  {
    "stem": "A client has lost control, is swinging at staff, and is at peak aggression. What is the nursing priority in this phase?",
    "options": [
  ...
  {
    "stem": "A client who was recently aggressive has stopped struggling and appears to be calming down. What is the appropriate nursing approach during this phase?",
    "options": [
  ...
  {
    "stem": "A client who was aggressive earlier now appears ashamed, remorseful, and exhausted. What is the appropriate nursing approach?",
    "options": [
  ...
  {
    "stem": "When is consent required before applying medication or treatment to a patient?",
    "options": [
  ...
  {
    "stem": "A provider orders forced IM medication for an agitated patient who is not in immediate danger to self or others. How should the nurse classify this order?",
    "options": [
  ...
  {
    "stem": "Which of the following are examples of non-therapeutic responses to an escalating patient? Select all that apply.",
    "options": [
  ...
  {
    "stem": "What makes a pattern of behavior a personality disorder rather than just an unusual personal style?",
    "options": [
  ...
  {
    "stem": "Which intervention pairings correctly match a nursing approach to the cluster or disorder it targets? Select all that apply.",
    "options": [
  ...
  {
    "stem": "Both borderline and antisocial personality disorder require the same core staffing intervention. What is it, and why does it matter equally for both?",
    "options": [
  ...
  {
    "stem": "A client with liver impairment needs a benzodiazepine. Which agents are preferred because they bypass phase-I liver metabolism?",
    "options": [
  ...
  {
    "stem": "An elderly client is given a benzodiazepine for anxiety and becomes more agitated and disinhibited rather than calmer. What is the explanation, and which populations are at particular risk?",
    "options": [
  ...
  {
    "stem": "A client has been taking a benzodiazepine daily for several months and wants to stop. What is the correct approach?",
    "options": [
  ...
  {
    "stem": "Which anxiolytic is a sedating antihistamine that is non-habit-forming?",
    "options": [
      "Hydroxyzine",
      "Alprazolam",
      "Buspirone",
  ...
  {
    "stem": "Which factors contribute to the multifactorial etiology of OCD? Select all that apply.",
    "options": [
  ...
  {
    "stem": "A client with PTSD reports constantly scanning the environment for danger and feeling unable to relax even in safe settings. Which term describes this state?",
    "options": [
      "Hypervigilance",
      "Dysphoria",
      "Depersonalization",
  ...
  {
    "stem": "A client reports that her partner controls all household finances, requires her to ask permission before making any purchase, and keeps her without access to their joint bank account. Which type of abuse does this describe?",
    "options": [
      "Economic abuse",
      "Physical abuse",
      "Neglect",
  ...
  {
    "stem": "A depressed, withdrawn client is assessed as low risk for aggression toward others, consistent with the fact that depressed, catatonic, and anxious patients are the least likely to harm others. Does this low aggression risk mean the client is not a safety concern?",
    "options": [
