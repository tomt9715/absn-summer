window.QUESTIONS = [
  ...
  {
    stem: "A client states, 'Nothing will ever get better for me.' Which response is most therapeutic?",
    options: ["'It sounds like you're feeling hopeless right now.'", "'Of course it will — things always work out.'", "'You just need to think more positively.'", "'Why do you feel that way?'"],
    correct: 0,
    rationale: "Reflecting the feeling of hopelessness validates the client and opens further discussion. False reassurance, advice-giving, and 'why' questions are all non-therapeutic and shut the client down."
  },
  {
    stem: "A grieving client says, 'I lost my mother last week.' Which response demonstrates empathy rather than sympathy?",
    options: ["'Losing your mother must be very painful for you.'", "'I feel so sorry for you.'", "'I know exactly what you're going through — I lost mine too.'", "'At least she's no longer suffering.'"],
    correct: 0,
    rationale: "Naming the client's pain validates their experience (empathy). 'I feel so sorry for you' is sympathy, sharing the nurse's own loss projects, and 'at least...' minimizes the loss."
  },
  {
    stem: "A client hints at self-harm by saying, 'Sometimes I just don't see the point anymore.' What is the nurse's best response?",
    options: ["'Are you thinking about hurting or killing yourself?'", "'I'm sure things will look brighter tomorrow.'", "'You shouldn't talk like that.'", "'Let's focus on something more positive.'"],
    correct: 0,
    rationale: "The nurse must ask directly about self-harm — clarification. Asking directly does not increase risk; it is the only way to assess it. The other responses avoid the issue and miss a potential safety concern."
  },
  {
    stem: "During a one-on-one, a client suddenly stops talking and begins to cry. What is the most therapeutic nursing action?",
    options: ["Remain present and allow silence, offering a tissue", "Quickly change the subject to something lighter", "Leave the room so the client can cry alone", "Tell the client that crying won't help"],
    correct: 0,
    rationale: "Staying present and allowing silence is therapeutic — silence gives the client space and communicates support. Changing the subject, leaving, or dismissing the crying are all non-therapeutic."
  },
  {
  ...
  {
    stem: "A new nurse asks how to respond when a depressed client says, 'I don't feel like talking right now.' What is the best guidance?",
    options: ["Offer presence: 'That's okay. I'll sit here with you for a bit.'", "Insist the client talk because expressing feelings is required", "Tell the client to call when they're ready and leave", "Reassure the client that talking always makes things better"],
    correct: 0,
    rationale: "Offering quiet presence respects the client's wishes while showing support — silence is therapeutic. Forcing conversation or leaving abruptly are both non-therapeutic, and 'talking always helps' is false reassurance."
  },
  {
