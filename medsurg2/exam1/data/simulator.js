...
window.QUESTIONS = [
  ...
  // ===== DYSRHYTHMIAS (~12) =====
  {
    stem: "A patient with known atrial fibrillation is brought to the emergency department by family who report he became suddenly confused and cannot speak or move his right arm. Symptoms began 45 minutes ago. He is not anticoagulated. What is the nurse's priority action?",
    options: ["Notify the provider immediately and prepare for emergent CT head — this presentation is consistent with cardioembolic stroke", "Administer the patient's home diltiazem and monitor the heart rate closely for rate control", "Apply oxygen via nasal cannula at 2 L/min and reassure the family while awaiting the provider", "Obtain a 12-lead electrocardiogram (ECG) and wait for cardiology to evaluate before taking any action"],
    correct: 0,
    rationale: "Atrial fibrillation is the most common cardiac cause of embolic stroke — clots form in the stagnant atria and embolize to the brain. Sudden unilateral weakness, aphasia, and confusion with onset 45 minutes ago is an acute ischemic stroke until proven otherwise. The priority is immediate CT head to rule out hemorrhage and determine eligibility for thrombolytics. Time is brain — every minute delays worsens outcome."
  },
  {
    stem: "A patient who underwent coronary artery bypass surgery 2 days ago develops sudden hypotension (BP 70/40 mmHg), muffled heart sounds, and distended neck veins. The cardiac monitor shows sinus tachycardia at 118 bpm. What does the nurse suspect and what is the priority action?",
    options: ["Cardiac tamponade — notify the provider immediately and prepare for emergency pericardiocentesis", "Hypovolemia — increase IV fluid rate to 200 mL/hr and recheck blood pressure in 15 minutes", "Pulmonary embolism (PE) — prepare the patient for emergent anticoagulation with IV heparin", "Cardiogenic shock — prepare for dopamine infusion and obtain a 12-lead electrocardiogram (ECG)"],
    correct: 0,
    rationale: "Beck's triad — hypotension, muffled heart sounds, and jugular venous distension — is the classic presentation of cardiac tamponade. Post-cardiac surgery patients are at high risk. Blood accumulating in the pericardial sac compresses the heart, reducing filling and cardiac output. This is a life-threatening emergency requiring immediate provider notification and preparation for pericardiocentesis. Fluids may temporarily help but pericardiocentesis is definitive."
  },
  {
  ...
  {
    stem: "A patient is admitted after receiving an excessive dose of metoprolol. The patient is drowsy with a heart rate of 38 bpm and blood pressure of 78/44 mmHg. IV access is established. Which intervention does the nurse anticipate first?",
    options: ["IV glucagon, which stimulates the heart independently of beta receptors and is the antidote for beta blocker overdose", "IV atropine 0.5 mg, then calcium gluconate if no response", "Immediate defibrillation since bradycardia from overdose is a shockable rhythm", "Administer IV epinephrine at maximum dose and prepare for transcutaneous pacing"],
    correct: 0,
    rationale: "IV glucagon is the specific antidote for beta blocker overdose — it stimulates cardiac glucagon receptors, increasing heart rate and contractility independently of beta receptors, bypassing the blockade. Atropine has limited effectiveness in beta blocker overdose. Defibrillation is not indicated for bradycardia with a pulse. Epinephrine is a later option if glucagon fails, but glucagon is first-line."
  },
  {
    stem: "A patient with a history of ventricular tachycardia is admitted for palpitations. An amiodarone infusion has been running for 4 hours. The patient reports new blurred vision and is now coughing up pink frothy sputum. Which complication does the nurse suspect and what is the priority action?",
    options: ["Amiodarone-induced pulmonary toxicity — stop the infusion, notify the provider, and prepare for respiratory support", "Expected side effects of amiodarone — reassure the patient and continue the infusion at the current rate", "Worsening ventricular tachycardia causing pulmonary congestion — increase the amiodarone rate immediately", "Fluid overload from IV fluids — administer IV furosemide 40 mg and slow the amiodarone rate"],
    correct: 0,
    rationale: "Amiodarone has serious pulmonary toxicity — it can cause alveolar inflammation and pulmonary edema even during acute IV administration. Pink frothy sputum indicates pulmonary edema, and vision changes are a known amiodarone side effect (corneal microdeposits, optic neuropathy). The infusion must be stopped immediately and the provider notified. These are not expected effects — they are serious toxicity signals requiring urgent intervention."
  },
  {
