...
window.QUESTIONS = [
  ...
  {
    stem: "A patient post-stapedectomy asks why they must avoid nose blowing, straining, and air travel for several weeks. Which explanation is most accurate?",
    options: ["These activities create pressure changes that can displace the prosthesis or damage the delicate surgical repair", "Nose blowing will introduce bacteria into the middle ear through the eustachian tube causing infection", "Air travel is restricted because altitude changes cause the surgical graft to absorb fluid and expand", "Straining is restricted only because it raises blood pressure and risks postoperative hemorrhage"],
    correct: 0,
    rationale: "After stapedectomy, the delicate prosthesis and perilymph seal are vulnerable. Nose blowing, straining, and pressure changes from air travel can displace the prosthesis or tear the oval window membrane, causing conductive hearing loss or perilymph fistula. Patients must avoid these activities for the prescribed period."
  },
  {
  ...
  {
    stem: "Which post-operative instruction is most important for a patient after enucleation of the right eye?",
    options: ["Report any changes in the remaining left eye immediately, as vision loss in that eye would be catastrophic", "Keep the prosthetic eye in at all times to prevent shrinkage of the socket", "Avoid all activity for 6 weeks to prevent displacement of the ocular implant", "Irrigate the socket with hydrogen peroxide daily to prevent infection"],
    correct: 0,
    rationale: "After enucleation, protecting the remaining eye becomes the highest priority. Any changes in the surviving eye — pain, vision changes, redness — must be reported immediately, as loss of the remaining eye would leave the patient completely blind. The prosthesis is cared for per provider instructions, not worn continuously without removal."
  },

  // ===== DYSRHYTHMIAS (~12) =====
  {
    stem: "A patient in the cardiac care unit has a rhythm showing no P waves, irregular R-to-R intervals, and a ventricular rate of 110 bpm. Blood pressure is 88/52 mmHg and the patient is confused. What is the priority intervention?",
    options: ["Prepare for immediate synchronized cardioversion", "Administer metoprolol IV push for rate control", "Perform vagal maneuvers and reassess", "Begin cardiopulmonary resuscitation (CPR) immediately"],
    correct: 0,
    rationale: "This is atrial fibrillation with rapid ventricular response causing hemodynamic instability (hypotension, altered mental status). This is an emergency — synchronized cardioversion is indicated when the patient is hemodynamically unstable with a pulse. Medications are used for stable patients. cardiopulmonary resuscitation (CPR) is not indicated as the patient has a pulse."
  },
  {
    stem: "A post-operative patient develops the following rhythm: regular rate of 42 bpm, narrow QRS, upright P waves before every QRS, PR interval 0.18 seconds. The patient is diaphoretic with blood pressure of 80/50 mmHg. What is the priority action?",
    options: ["Administer atropine 0.5 mg IV push and prepare for transcutaneous pacing", "Administer adenosine 6 mg IV push to break the rhythm", "Prepare the patient for immediate defibrillation", "Increase IV fluid rate to improve blood pressure and recheck in 15 minutes"],
    correct: 0,
    rationale: "This is symptomatic sinus bradycardia — rate 42, hemodynamically unstable. Atropine 0.5 mg IV push is first-line treatment for symptomatic bradycardia. Transcutaneous pacing is prepared as backup if atropine fails. Adenosine is for supraventricular tachycardia (SVT). Defibrillation is for pulseless ventricular fibrillation or pulseless ventricular tachycardia."
  },
  {
    stem: "A patient's rhythm strip shows a pattern where the PR interval measures 0.22 seconds and is the same for every beat, with a QRS after every P wave. The patient is asymptomatic with a blood pressure of 126/78 mmHg. What is the appropriate nursing action?",
    options: ["Continue monitoring — first degree heart block in an asymptomatic patient requires no immediate intervention", "Administer atropine 0.5 mg IV and prepare for transcutaneous pacing", "Notify the provider for immediate cardioversion", "Initiate cardiopulmonary resuscitation (CPR) — this block can progress to asystole at any moment"],
    correct: 0,
    rationale: "First degree heart block is a prolonged PR interval (> 0.20 sec) where every P wave conducts — no beats are dropped. In an asymptomatic patient with stable vitals, no treatment is required. The nurse should continue monitoring for progression to a higher degree block. Atropine and pacing are for symptomatic bradycardia."
  },
  {
    stem: "A patient develops the following rhythm: progressively lengthening PR intervals over 3 beats, then a QRS is dropped, then the cycle repeats. The ventricular rate is 52 bpm and the patient feels mildly lightheaded. What does the nurse anticipate?",
    options: ["Notify the provider — this is second degree type 1 block (Wenckebach) and may require atropine or pacing if symptoms worsen", "Prepare for immediate defibrillation — this rhythm is imminently fatal", "Administer adenosine IV to break the reentrant circuit causing the dropped beats", "Reassure the patient — Wenckebach is always benign and requires no intervention"],
    correct: 0,
    rationale: "Second degree type 1 (Wenckebach) has a characteristic pattern of progressive PR lengthening then a dropped QRS. Mild symptoms (lightheadedness) with a rate of 52 warrant provider notification. If symptoms worsen or the patient becomes hemodynamically unstable, atropine or pacing may be needed. It is not immediately fatal, but it is not always benign — it can progress."
  },
  {
    stem: "A patient's monitor shows a regular wide bizarre QRS rhythm at 180 bpm. The patient is responsive and has a blood pressure of 102/68 mmHg. What is the priority nursing action?",
    options: ["Notify the provider immediately and prepare for synchronized cardioversion if the patient deteriorates", "Begin immediate unsynchronized defibrillation at maximum joules", "Administer adenosine 6 mg IV push for this narrow complex tachycardia", "Reassure the patient and continue monitoring — a blood pressure over 90 mmHg is acceptable"],
    correct: 0,
    rationale: "This is ventricular tachycardia (VT) with a pulse — wide bizarre QRS at a fast rate. The patient is currently stable (responsive, BP > 90). Stable VT is managed medically (amiodarone) with close monitoring and preparation for cardioversion if hemodynamic status deteriorates. Immediate defibrillation is for pulseless VT or ventricular fibrillation. Adenosine is for supraventricular tachycardia (SVT) with narrow QRS."
  },
  {
    stem: "A nurse is caring for a patient with a permanent pacemaker set at 60 bpm. The rhythm strip shows a pacemaker spike not followed by a QRS complex at a rate of 54 bpm. How should the nurse interpret this finding?",
    options: ["Failure to capture — the pacemaker is firing but the ventricle is not responding; notify the provider", "Normal pacemaker function — the native rate is 54 and the pacer appropriately inhibits", "Failure to sense — the pacemaker is not detecting the native rhythm and is firing competitively", "Rate responsiveness — the pacemaker is appropriately adjusting to the patient's activity level"],
    correct: 0,
    rationale: "A pacemaker spike not followed by a QRS complex indicates failure to capture — the electrical impulse is being delivered but the myocardium is not depolarizing in response. This is a malfunction requiring immediate provider notification. Possible causes include lead displacement, battery depletion, or increased pacing threshold. Failure to sense is when the pacemaker fires in competition with native beats."
  },
  {
  ...
  {
    stem: "A patient has the following electrocardiogram (ECG) finding: P waves present but with no consistent relationship to QRS complexes, ventricular rate 38 bpm, wide QRS complexes. The patient is hemodynamically unstable. What does the nurse prepare for?",
    options: ["Emergency transcutaneous pacing and potential transvenous pacemaker insertion", "Immediate adenosine administration to restore atrioventricular (AV) nodal conduction", "Synchronized cardioversion at 200 joules to reset the conduction system", "IV atropine 2 mg as definitive treatment for this block"],
    correct: 0,
    rationale: "Complete (third degree) heart block shows total dissociation between P waves and QRS complexes — the atria and ventricles beat independently. The wide QRS indicates a ventricular escape rhythm. With hemodynamic instability, transcutaneous pacing is the emergency intervention, followed by transvenous pacing. Atropine has limited effectiveness in complete heart block with ventricular escape. Cardioversion is not indicated."
  },
  {
  ...
  {
    stem: "A patient's potassium level is 2.9 mEq/L. Which electrocardiogram (ECG) change does the nurse anticipate, and what is the clinical significance?",
    options: ["Prominent U wave and flat T waves — increased risk of ventricular dysrhythmias including Torsades de Pointes", "Peaked narrow T waves — indicates hyperkalemia from potassium redistribution", "Widened QRS and absent P waves — indicates severe toxicity requiring immediate defibrillation", "ST elevation — indicates myocardial ischemia triggered by the electrolyte imbalance"],
    correct: 0,
    rationale: "Hypokalemia (K+ < 3.5 mEq/L) produces flat or inverted T waves and prominent U waves on the electrocardiogram (ECG). The clinical danger is that hypokalemia prolongs the QT interval and predisposes to Torsades de Pointes and other ventricular dysrhythmias. Potassium replacement is required, with IV KCl given slowly via infusion pump when levels are critically low."
  },
  {
    stem: "A nurse receives a rhythm strip showing sawtooth flutter waves at approximately 300 per minute with a ventricular response of 75 bpm. The patient is comfortable with a blood pressure of 124/80 mmHg. Which medication does the nurse anticipate?",
    options: ["Diltiazem or metoprolol for rate control", "Atropine 0.5 mg IV for the bradycardic atrial rate", "Adenosine 6 mg IV push to convert the rhythm", "Lidocaine IV infusion to suppress the ectopic atrial focus"],
    correct: 0,
    rationale: "Atrial flutter with a controlled ventricular response (75 bpm) in a stable patient is managed with rate control using calcium channel blockers (diltiazem) or beta blockers (metoprolol). Atropine increases heart rate and would worsen the situation. Adenosine can be used diagnostically to reveal flutter waves but does not convert flutter. Lidocaine is for ventricular dysrhythmias, not atrial."
  },
  ...
  {
    stem: "A nurse is performing postural drainage on a patient with chronic bronchitis. Which position facilitates drainage of the right lower lobe?",
    options: ["Left lateral Trendelenburg (head down, lying on left side)", "High Fowler's position with head of bed elevated 90 degrees", "Supine with pillow under the knees to flatten the lumbar spine", "Right lateral decubitus (lying on right side) with head elevated"],
    correct: 0,
    rationale: "Postural drainage uses gravity to mobilize secretions from peripheral airways. To drain the right lower lobe, the patient must be positioned so the right lower lobe is uppermost and gravity can drain toward the bronchi — left lateral with Trendelenburg (head down) position. High Fowler's would not facilitate drainage of lower lobes. Understanding lobe anatomy and gravity direction is key."
  },
  {
  ...
  {
    stem: "A patient with lung cancer receiving chemotherapy has an absolute neutrophil count (ANC) of 400 cells/mm³. Which intervention is the highest priority?",
    options: ["Implement neutropenic precautions and instruct the patient to report any fever above 38°C (100.4°F) immediately", "Administer a live attenuated influenza vaccine to protect against respiratory infection", "Encourage the patient to rest but allow unrestricted visitors to support emotional well-being", "Hold all medications and await count recovery before continuing any treatment or nursing care"],
    correct: 0,
    rationale: "An absolute neutrophil count (ANC) below 500 is severe neutropenia — the patient has virtually no immune defense against infection. Neutropenic precautions (private room, hand hygiene, avoiding sick visitors, no live vaccines, low-microbial diet) are essential. Fever above 38°C in a neutropenic patient is a medical emergency requiring immediate evaluation and broad-spectrum antibiotics. Live vaccines are absolutely contraindicated."
  },
  {
  ...
  {
    stem: "A patient develops the following arterial blood gas (ABG) after a seizure: pH 7.18, PaCO₂ 52 mmHg, HCO₃⁻ 18 mEq/L. Which interpretation is most accurate?",
    options: ["Mixed respiratory and metabolic acidosis — both the lungs and metabolism are contributing to the acidosis", "Uncompensated respiratory acidosis — the metabolic component is within normal limits", "Partially compensated metabolic acidosis — the lungs are hypoventilating as compensation", "Fully compensated respiratory acidosis — the kidneys have restored the pH to normal"],
    correct: 0,
    rationale: "pH 7.18 is severely acidotic. PaCO₂ 52 is elevated (acid column = respiratory component). HCO₃⁻ 18 is low (acid column = metabolic component). Both are abnormal in the acid direction — this is a mixed respiratory and metabolic acidosis. After a seizure, lactic acidosis from muscle activity causes metabolic acidosis, while post-ictal hypoventilation causes respiratory acidosis. Compensation moves values in opposite directions — here both move the same way, indicating mixed etiology."
  },
  {
    stem: "A patient with decompensated cirrhosis has 3+ pitting edema, ascites, and a blood pressure of 82/50 mmHg. The nurse understands that despite the visible fluid excess, the low blood pressure is best explained by which mechanism?",
    options: ["Third spacing — fluid trapped in the peritoneal cavity and interstitium is unavailable to maintain circulating volume", "The liver is producing too much albumin, causing fluid to shift into the vascular space inappropriately", "The heart is pumping too forcefully, creating a pressure gradient that pulls fluid from vessels", "Diuretic therapy has removed too much fluid from the vascular compartment causing hypovolemia"],
    correct: 0,
    rationale: "Third spacing in cirrhosis — hypoalbuminemia reduces oncotic pressure, causing fluid to shift out of vessels into the peritoneal cavity (ascites) and interstitium (edema). Despite visible fluid overload, circulating volume is depleted. The patient is functionally hypovolemic. This explains why these patients are hypotensive despite appearing edematous — the vascular compartment is empty even though total body fluid is increased."
  },
  {
  ...
  {
    stem: "A patient receives 3 liters of normal saline for hypovolemic shock. Six hours later, the nurse notes a serum sodium of 148 mEq/L and serum chloride of 114 mEq/L with a non-anion gap metabolic acidosis. Which complication has likely occurred?",
    options: ["Hyperchloremic metabolic acidosis from large-volume normal saline administration", "Dilutional hyponatremia from excessive free water in the normal saline solution", "Respiratory alkalosis triggered by the stress of fluid resuscitation", "Normal post-resuscitation findings — these values require no intervention"],
    correct: 0,
    rationale: "Normal saline (0.9% NaCl) contains supraphysiologic chloride (154 mEq/L vs plasma 100 mEq/L). Large volumes cause hyperchloremic metabolic acidosis — excess chloride displaces bicarbonate. This is a well-recognized complication of large-volume normal saline resuscitation. Balanced solutions like Lactated Ringer's are increasingly preferred to avoid this. The nurse should notify the provider and anticipate fluid type adjustment."
  },
  {
  ...
  {
    stem: "A patient receiving total parenteral nutrition (TPN) develops confusion, muscle weakness, and respiratory distress. Serum phosphate is 1.2 mg/dL. Which condition does the nurse suspect and what is the mechanism?",
    options: ["Refeeding syndrome — rapid glucose infusion drives phosphate into cells, depleting serum levels", "Hyperphosphatemia — excess phosphate in total parenteral nutrition (TPN) is overwhelming renal excretion capacity", "Hypocalcemia — low phosphate inversely raises calcium, causing neuromuscular excitability", "Respiratory alkalosis — the total parenteral nutrition (TPN) solution is too alkaline, causing pH-driven phosphate shifts"],
    correct: 0,
    rationale: "Refeeding syndrome occurs when malnourished patients receive aggressive nutrition — insulin release from carbohydrate infusion drives phosphate (and potassium, magnesium) from blood into cells, causing severe hypophosphatemia. Serum phosphate < 1.5 mg/dL causes respiratory muscle weakness (diaphragm failure), confusion, hemolytic anemia, and cardiac dysfunction. Total parenteral nutrition (TPN) must be started slowly in malnourished patients."
  },
  {
