...
**Neurodevelopmental Disorders (Ch 22)** — KC complete (36 questions), DD not yet built.
...
Next: Ch 22 Deep Drill, then repeat the KC+DD pattern for Ch 23, 20, 21, then a cumulative simulator once all five topics exist.
