...
Next: Section 2 (Defense Mechanisms, source: exam1 Theories), then continue through Unit 6's remaining sections (Assessment/Crisis vocab, Schizophrenia & Psychosis, Mood/Lithium/Suicide, Substance Use/Withdrawal, then the Exam 3 rapid-refresher topics) one at a time, appending to the same data file each time.
